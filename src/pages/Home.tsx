...
import { ObraviolLogo, ObraviolIcon } from '../components/ObraviolLogo';
import {
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0D1B2A]/80 backdrop-blur-xl border-b border-white/5">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="#built-different" className="text-sm text-white/60 hover:text-white transition-colors">Built Different</a>
          <a href="#early-access" className="text-sm text-white/60 hover:text-white transition-colors">Early Access</a>
      ...
      {open && (
        <div className="md:hidden bg-[#0D1B2A]/95 backdrop-blur-xl border-t border-white/5 px-6 py-4 space-y-3">
...
function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ background: 'linear-gradient(135deg, #0D1B2A 0%, #111D2E 50%, #0D1B2A 100%)' }}>
      {/* Dot grid */}
      <div className="absolute inset-0 dot-grid opacity-60" />

      {/* Gradient orbs */}
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#C8102E]/8 rounded-full blur-[150px]" />
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-[#C8102E]/5 rounded-full blur-[120px]" />

      {/* Floating shapes */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="floating-shape absolute top-[20%] left-[-5%]" style={{ animationDelay: '0s' }}>
          <div className="w-[500px] h-[120px] rounded-full bg-gradient-to-r from-[#C8102E]/10 to-transparent border border-white/5 rotate-12 backdrop-blur-sm" />
        </div>
        <div className="floating-shape absolute bottom-[15%] right-[-3%]" style={{ animationDelay: '4s' }}>
          <div className="w-[400px] h-[100px] rounded-full bg-gradient-to-r from-white/5 to-transparent border border-white/5 -rotate-12 backdrop-blur-sm" />
        </div>
        <div className="floating-shape absolute top-[10%] right-[10%]" style={{ animationDelay: '2s' }}>
          <div className="w-[200px] h-[60px] rounded-full bg-gradient-to-r from-[#C8102E]/8 to-transparent border border-white/5 rotate-[20deg] backdrop-blur-sm" />
        </div>
        <div className="floating-shape absolute bottom-[25%] left-[8%]" style={{ animationDelay: '6s' }}>
          <div className="w-[250px] h-[70px] rounded-full bg-gradient-to-r from-white/4 to-transparent border border-white/5 -rotate-[8deg] backdrop-blur-sm" />
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center pt-20">
        {/* Badge */}
        <div className="fade-in inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.04] border border-white/10 mb-10">
          <span className="h-2 w-2 rounded-full bg-[#C8102E] pulse-glow" />
          <span className="text-sm text-white/60 tracking-wide">Now in Early Access</span>
        </div>
        ...
        <h1 className="fade-in-d2 text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-[800] tracking-tight leading-[0.95] mb-8">
          ...
          <span className="text-[#C8102E]">Reimagined</span>
        </h1>
        ...
        <div className="fade-in-d4 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a href="https://app.obravio.com" target="_blank" rel="noopener noreferrer" className="px-8 py-3.5 border border-white/20 hover:border-white/40 text-white/80 hover:text-white font-medium rounded-lg transition-all text-base">
            Log in to Obravio
          </a>
          <a href="https://estimate.obravio.com" target="_blank" rel="noopener noreferrer" className="px-8 py-3.5 border border-white/20 hover:border-white/40 text-white/80 hover:text-white font-medium rounded-lg transition-all text-base">
            Log in to Estimate
          </a>
        </div>
      </div>
...
function Features() {
  return (
    <section id="features" className="py-24 md:py-32 bg-[#0D1B2A] relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-[800] tracking-tight mb-4">
            <span className="text-white">Everything You Need. </span>
            <span className="text-[#C8102E]">Nothing You Don't.</span>
          </h2>
          <p className="text-white/40 text-lg max-w-xl mx-auto">One platform. Every tool a GC needs to run the job.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f) => (
            <div key={f.title} className="group relative p-7 rounded-2xl bg-white/[0.02] border border-white/[0.06] hover:border-[#C8102E]/30 transition-all duration-300 hover:-translate-y-1.5">
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#C8102E]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
...
function BuiltDifferent() {
  return (
    <section id="built-different" className="py-24 md:py-32 relative overflow-hidden" style={{ background: 'linear-gradient(180deg, #091420 0%, #0D1B2A 100%)' }}>
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-[800] tracking-tight mb-6">
          <span className="text-white">Built by a GC. </span>
          <span className="text-white/50">Not a Tech Bro.</span>
        </h2>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
          {badges.map((b) => (
            <div key={b.label} className="flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/[0.03] border border-white/[0.08] text-white/50 hover:border-[#C8102E]/20 hover:text-white/70 transition-all">
              <b.icon className="w-4 h-4 text-[#C8102E]" />
...
function EarlyAccess() {
  ...
  return (
    <section id="early-access" className="py-24 md:py-32 bg-[#0D1B2A] relative">
      <div className="absolute inset-0 dot-grid opacity-30" />
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-[600px] h-[400px] bg-[#C8102E]/[0.05] rounded-full blur-[120px]" />
      </div>
      <div className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-[800] tracking-tight mb-4 text-white">Early Access Opening Soon</h2>
...
function Footer() {
  return (
    <footer className="py-12 bg-[#091420] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8">
            ...
            <a href="mailto:hello@obravio.com" className="text-sm text-white/40 hover:text-white/70 transition-colors">Contact</a>
          </div>
          <div className="flex items-center gap-2 text-white/30 text-sm">
            <Palmtree className="w-4 h-4 text-[#C8102E]/60" /><span>Made in Miami</span>
          </div>
        </div>
